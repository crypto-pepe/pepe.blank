...
document.addEventListener("DOMContentLoaded", () => {
  ...
  openGameButton.addEventListener("click", () => {
    const game = document.querySelector(".game");
    game.classList.add("game-opened");
  ...
  var soundDie = new buzz.sound("../img/assets/sounds/sfx_die.ogg");
  var soundSwoosh = new buzz.sound("../img/assets/sounds/sfx_swooshing.ogg");
  ...
  function setSmallScore() {
    ...
    for (var i = 0; i < digits.length; i++)
      elemscore.append(
        "<img src='../img/assets/font_small_" +
          digits[i] +
          ".png' alt='" +
          digits[i] +
          "'>"
  ...
  function setMedal() {
    ...
    elemmedal.append(
      '<img src="../img/assets/medal_' + medal + '.png" alt="' + medal + '">'
    );
